  ...
  <div class="modal-dialog modal-default" id="frmEntry">
    <div class="modal-content">
      <div class="modal-header" style="padding:10px 15px 10px 15px;">
        ...
        <h4 class="modal-title"><b><span id="judul-form"> </span>HARGA KONSTAN</b></h4>
      </div>
      <?php echo form_open_multipart(site_url('ekonomi_makro_mikro/harga_konstan/create'), array('id' => 'formEntry')); ?>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-12">
            <div class="form-group required">
              ...
              <input type="text" class="form-control" name="jenis_pdrb" id="jenis_pdrb" value="harga konstan" placeholder="Harga berlaku" readonly>
              <div class="help-block"></div>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-12">
            <div class="form-group required">
              <label for="harga_konstan" class="control-label"><b>Harga Konstan <font color="red">*</font></b></label>
              <input step="0.01" type="number" class="form-control" name="harga_konstan" id="harga_konstan" placeholder="Harga Konstan ">
              <div class="help-block"></div>
            </div>
          </div>
        </div>
