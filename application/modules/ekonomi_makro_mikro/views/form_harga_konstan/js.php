<script type="text/javascript">
  $(function() {
    ...
    mainTbl = $('#mainTbl').dataTable({
      ...
      ordering: false,
      ajax: {
        url: site + "ekonomi_makro_mikro/harga_konstan/listview",
        type: "POST",
        data: function(d) {
    ...
    // Form Reset
    function formReset() {
      $('#formEntry').attr('action', site + 'ekonomi_makro_mikro/harga_konstan/create');
      $('#errEntry').html('');
      $('.help-block').text('');
    ...
    $(document).on('click', '.btnEdit', function(e) {
      ...
      e.stopPropagation();
      formReset();
      $('#formEntry').attr('action', site + 'ekonomi_makro_mikro/harga_konstan/update');
      ...
      $('#harga_konstan').val(data.harga_pdrb);
    ...
    $(document).on('click', '.btnDelete', function(e) {
      ...
      bootbox.dialog({
        title: "Konfirmasi",
        message: "Apakah anda ingin menghapus data tersebut ?",
        buttons: {
          "cancel": {
          ...
          "main": {
            ...
            callback: function(response) {
              if (response) {
                $.ajax({
                  url: site + 'ekonomi_makro_mikro/harga_konstan/delete',
                  type: "POST",
                  data: postData,
                  dataType: "json",
                }).done(function(data) {
    ...
    $(document).on('click', '#printExcel', function(e) {
      ...
      url = site + 'ekonomi_makro_mikro/harga_konstan/export-to-excel?lapangan=' + id_lapusaha_filter + '&tahun=' + tahun;
