    ...
    <div class="modal-dialog modal-default" id="frmEntry">
        <div class="modal-content">
            <div class="modal-header" style="padding:10px 15px 10px 15px;">
                ...
                <h4 class="modal-title"><b><span id="judul-form"> </span>LAPANGAN USAHA</b></h4>
            </div>
            <?php echo form_open_multipart(site_url('ekonomi_makro_mikro/lapangan_usaha/create'), array('id' => 'formEntry')); ?>
            <div class="modal-body" style="padding:15px 15px 5px 15px;">
                <div id="errEntry"></div>
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group required">
                            <input type="hidden" name="id_lapangan_usaha" id="id_lapangan_usaha">
                            <label for="nama" class="control-label"><b>Lapangan Usaha <font color="red">*</font></b></label>
                            <input type="text" class="form-control" name="nama" id="nama" placeholder="Lapangan Usaha">
