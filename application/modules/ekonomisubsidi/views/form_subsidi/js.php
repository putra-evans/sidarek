<script type="text/javascript">
    $(function() {
        ...
        mainTbl = $('#mainTbl').dataTable({
            ...
            ordering: false,
            ajax: {
                url: site + "ekonomisubsidi/subsidi/listview/",
                type: "POST",
                data: function(d) {
        ...
        // Form Reset
        function formReset() {
            $('#formEntry').attr('action', site + 'ekonomisubsidi/subsidi/create');
            $('#errEntry').html('');
            $('.help-block').text('');
            ...
            $('#id_subsidi_kategori').val('').trigger('change');
            $('#nama').val('');
        }
        ...
        $(document).on('click', '.btnEdit', function(e) {
            ...
            e.stopPropagation();
            formReset();
            $('#formEntry').attr('action', site + 'ekonomisubsidi/subsidi/update');

            $('#id_subsidi').val(data.id_subsidi);
            $('#id_subsidi_kategori').select2('val', data.id_subsidi_kategori);
            $('#nama').val(data.subsidi);
                ...
                buttons: {
                    ...
                    "main": {
                        ...
                        callback: function(response) {
                            if (response) {
                                $.ajax({
                                    url: site + 'ekonomisubsidi/subsidi/delete',
                                    type: "POST",
                                    data: postData,
                                    dataType: "json",
                                }).done(function(data) {
