<script type="text/javascript">
    $(function() {
        ...
        mainTbl = $('#mainTbl').dataTable({
            ...
            ordering: false,
            ajax: {
                url: site + "ekonomiusaha/umkmb/listview/",
                type: "POST",
                data: function(d) {
        ...
        // Form Reset
        function formReset() {
            $('#formEntry').attr('action', site + 'ekonomiusaha/umkmb/create');
            $('#errEntry').html('');
            $('.help-block').text('');
        ...
        $(document).on('click', '.btnEdit', function(e) {
            ...
            e.stopPropagation();
            formReset();
            $('#formEntry').attr('action', site + 'ekonomiusaha/umkmb/update');

            $('#id_umkmb').val(data.id_umkmb);
            $('#id_regency').val(data.id_regency).trigger('change');
            $('#tahun').val(data.tahun).trigger('change');

            $('#umk').val(data.umk);
            $('#umb').val(data.umb);
            $('#tk_umk').val(data.tk_umk);
            $('#tk_umb').val(data.tk_umb);
                ...
                buttons: {
                    ...
                    "main": {
                        ...
                        callback: function(response) {
                            if (response) {
                                $.ajax({
                                    url: site + 'ekonomiusaha/umkmb/delete',
                                    type: "POST",
                                    data: postData,
                                    dataType: "json",
                                }).done(function(data) {
        ...
        $(document).on('click', '#printExcel', function(e) {
            ...
            url = site + 'ekonomiusaha/umkmb/export-to-excel?tahun=' + tahun_filter + '&kabkota=' + id_regency_filter;
