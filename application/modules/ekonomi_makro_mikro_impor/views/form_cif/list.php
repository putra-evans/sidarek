                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group">
                                    <label style="font-size:16px;"><b>Berdasarkan Golongan Barang </b></label>
                                    <?php echo form_dropdown('golongan', $golongan, $this->input->post('golongan', TRUE), 'class="select-all"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3">
...
<?php $this->load->view("ekonomi_makro_mikro_impor/form_cif/modal.php") ?>
<?php $this->load->view("ekonomi_makro_mikro_impor/form_cif/js.php") ?>