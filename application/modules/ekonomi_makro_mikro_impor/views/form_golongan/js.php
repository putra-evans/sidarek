<script type="text/javascript">
    $(function() {
        ...
        mainTbl = $('#mainTbl').dataTable({
            ...
            ordering: false,
            ajax: {
                url: site + "ekonomi_makro_mikro_impor/golongan_barang/listview/",
                type: "POST",
                data: function(d) {
        ...
        // Form Reset
        function formReset() {
            $('#formEntry').attr('action', site + 'ekonomi_makro_mikro_impor/golongan_barang/create');
            $('#errEntry').html('');
            $('.help-block').text('');
        ...
        $(document).on('click', '.btnEdit', function(e) {
            ...
            e.stopPropagation();
            formReset();
            $('#formEntry').attr('action', site + 'ekonomi_makro_mikro_impor/golongan_barang/update');

            $('#id_golongan').val(data.id_golongan);
            $('#nama').val(data.nama_golongan);
                ...
                buttons: {
                    ...
                    "main": {
                        ...
                        callback: function(response) {
                            if (response) {
                                $.ajax({
                                    url: site + 'ekonomi_makro_mikro_impor/golongan_barang/delete',
                                    type: "POST",
                                    data: postData,
                                    dataType: "json",
                                }).done(function(data) {
