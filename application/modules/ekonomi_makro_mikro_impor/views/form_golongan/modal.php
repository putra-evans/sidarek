<div class="modal fade in" id="modalEntryForm" tabindex="-1" role="dialog" aria-labelledby="modalEntryLabel" aria-hidden="true">
    <div class="modal-dialog modal-default" id="frmEntry">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(site_url('ekonomi_makro_mikro_impor/golongan_barang/create'), array('id' => 'formEntry')); ?>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group required">
                            ...
                            <label for="nama" class="control-label"><b>Golongan Barang <font color="red">*</font></b></label>
                            <input type="text" class="form-control" name="nama" id="nama" placeholder="Golongan Barang Impor">
