<div class="modal fade in" id="modalEntryForm" tabindex="-1" role="dialog" aria-labelledby="modalEntryLabel" aria-hidden="true">
  <div class="modal-dialog modal-default" id="frmEntry">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(site_url('ekonomiinflasi/komoditas_inflasi/create'), array('id' => 'formEntry')); ?>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-12">
            <div class="form-group required">
              <label for="komoditas" class="control-label"><b>Komoditas Penyumbang Inflasi <font color="red">*</font></b></label>
          ...
          <div class="col-xs-12 col-sm-12">
            <div class="form-group required">
              <label for="inflasi" class="control-label"><b>Inflasi <font color="red">*</font></b></label>
              <input type="text" placeholder="Inflasi (%mtm)" class="form-control" name="inflasi" id="inflasi">
              <div class="help-block"></div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-12">
