<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '#printExcel', function(e) {
      ...
      url = site + 'ekonomiinflasi/komoditas_inflasi/export-to-excel?jenis=' + jenis + '&bulan=' + bulan;
  ...
  mainTbl = $('#mainTbl').dataTable({
    ...
    ordering: false,
    ajax: {
      url: site + "ekonomiinflasi/komoditas_inflasi/listview",
      type: "POST",
      data: function(d) {
  ...
  // Form Reset
  function formReset() {
    $('#formEntry').attr('action', site + 'ekonomiinflasi/komoditas_inflasi/create');
    $('#errEntry').html('');
    $('.help-block').text('');
  ...
  $(document).on('click', '.btnEdit', function(e) {
    ...
    e.stopPropagation();
    formReset();
    $('#formEntry').attr('action', site + 'ekonomiinflasi/komoditas_inflasi/update');
      ...
      buttons: {
        ...
        "main": {
          ...
          callback: function(response) {
            if (response) {
              $.ajax({
                url: site + 'ekonomiinflasi/komoditas_inflasi/delete',
                type: "POST",
                data: postData,
                dataType: "json",
              }).done(function(data) {
