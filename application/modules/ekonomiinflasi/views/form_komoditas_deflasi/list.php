            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-hover table-bordered" id="mainTbl" width="100%">
              <thead>
                <tr>
                  ...
                  <th width="20%">Komoditas Penyumbang Deflasi</th>
                  <th width="15%">Deflasi (%mtm)</th>
...
<?php $this->load->view("ekonomiinflasi/form_komoditas_deflasi/modal.php") ?>
<?php $this->load->view("ekonomiinflasi/form_komoditas_deflasi/js.php") ?>