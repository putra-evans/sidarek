    ...
    <div class="modal-dialog modal-default" id="frmEntry">
        <div class="modal-content">
            <div class="modal-header" style="padding:10px 15px 10px 15px;">
                ...
                <h4 class="modal-title"><b><span id="judul-form"> </span>EKSPOR</b></h4>
            </div>
            <?php echo form_open_multipart(site_url('ekonomi_makro_mikro_ekspor/fob/create'), array('id' => 'formEntry')); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group required">
                            ...
                            <input type="hidden" name="id_ekspor" id="id_ekspor">
                            <?php echo form_dropdown('id_sektor', $sektor, $this->input->post('id_sektor', TRUE), 'class="select-all" id="id_sektor"'); ?>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group required">
                            <label for="nilaifob" class="control-label"><b>Nilai FOB <font color="red">*</font></b></label>
                            <input step="0.01" type="number" class="form-control" name="nilaifob" id="nilaifob" placeholder="Nilai FOB">
                            <div class="help-block"></div>
                        </div>
                    </div>
