                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group">
                                    <label style="font-size:16px;"><b>Berdasarkan Sektor </b></label>
                                    <?php echo form_dropdown('sektor', $sektor, $this->input->post('sektor', TRUE), 'class="select-all"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group required">
                                    ...
                                    <div class="input-group date monday_date_datepicker1" data-provide="datepicker" id="monday_date_datepicker1">
                                        <input type="text" id="add_monday_date1" name="monday_date1" class="form-control" data-date-format="yyyy-mm-dd" readonly>
...
<?php $this->load->view("ekonomi_makro_mikro_ekspor/form_fob/modal.php") ?>
<?php $this->load->view("ekonomi_makro_mikro_ekspor/form_fob/js.php") ?>