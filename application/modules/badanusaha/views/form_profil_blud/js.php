<script type="text/javascript">
  ...
  profiltbl = $('#profiltbl').dataTable({
    ...
    ordering: false,
    ajax: {
      url: site + "badanusaha/profil_blud/listview",
      type: "POST",
      data: function(d) {
    ...
    columns: [{
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          ...
          var penyertaanModal = '<a href="' + site + 'badanusaha/modal_blud/index/' + row.id_profil_bu + '" type="button" class="btn btn-xs btn-belt" id="aset" title="View data">Progress Perkembangan</a>';
  ...
  // Form Reset
  function formReset() {
    $('#formEntry').attr('action', site + 'badanusaha/profil_blud/create');
    $('#errEntry').html('');
    $('.help-block').text('');
  ...
  $(document).on('click', '.btnView', function(e) {
    ...
    $('#formEntry').attr('action', site + 'badanusaha/profil_blud/update');
    $('.lblPass').text('');
    $('#modalEntryForm').modal({
      backdrop: 'static'
    });
      ...
      buttons: {
        ...
        "main": {
          ...
          callback: function(response) {
            if (response) {
              $.ajax({
                url: site + 'badanusaha/profil_blud/delete',
                type: "POST",
                data: postData,
                dataType: "json",
              }).done(function(data) {
