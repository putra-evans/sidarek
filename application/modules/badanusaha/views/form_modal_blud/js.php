<script type="text/javascript">
    $(function() {
        ...
        penyertaanmodaltbl = $('#penyertaanmodaltbl').dataTable({
            ...
            ordering: false,
            ajax: {
                url: site + "badanusaha/modal_blud/listview/" + idProfilBU,
                type: "POST",
                data: function(d) {
        ...
        // Form Reset
        function formReset() {
            $('#formEntry').attr('action', site + 'badanusaha/modal_blud/create');
            $('#errEntry').html('');
            $('.help-block').text('');
                ...
                buttons: {
                    ...
                    "main": {
                        ...
                        callback: function(response) {
                            if (response) {
                                $.ajax({
                                    url: site + 'badanusaha/modal_blud/delete',
                                    type: "POST",
                                    data: postData,
                                    dataType: "json",
                                }).done(function(data) {
        ...
        $(document).on('click', '.penyertaanmodal', function(e) {
            ...
            $.ajax({
                url: site + "badanusaha/modal_blud/fetch",
                type: "POST",
                data: {
