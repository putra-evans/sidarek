...
class Modal_blud extends SLP_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('model_modal_blud' => 'mmb'));
        $this->csrf = array(
    ...
    public function index($id = null)
    {
        if (!isset($id)) {
            ...
            $this->breadcrumb->add('Dashboard', site_url('home'));
            $this->breadcrumb->add('BLUD', site_url('badanusaha/profil_blud'));
            $this->breadcrumb->add('Progress Perkembangan', site_url('badanusaha/modal_blud/index'));
    ...
    public function listview($id = null)
    {
        if (!isset($id)) {
            ...
            $resultDT = $this->mmb->process_datatables($param, $id);
    ...
    public function export_to_excel()
    {
        ...
        $dataRealisasi   = $this->mmb->getDataListBUReport($profil, $tahun);
