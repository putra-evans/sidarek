                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <?php echo form_dropdown('jenis', array('' => 'Jenis Penerbangan', 'Domestik' => 'Domestik', 'Internasional' => 'Internasional'), $this->input->post('jenis', TRUE), 'class="select-all"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3">
...
<?php $this->load->view("transportasi/form_transportasi/modal.php") ?>
<?php $this->load->view("transportasi/form_transportasi/js.php") ?>