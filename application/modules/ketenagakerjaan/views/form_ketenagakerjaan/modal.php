    ...
    <div class="modal-dialog modal-default" id="frmEntry">
        <div class="modal-content">
            <div class="modal-header" style="padding:10px 15px 10px 15px;">
                ...
                <h4 class="modal-title"><b><span id="judul-form"> </span>Ketenagakerjaan </b></h4>
            </div>
            <?php echo form_open_multipart(site_url('ketenagakerjaan/ketenagakerjaan/create'), array('id' => 'formEntry')); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group required">
                            <label style="font-size:16px;"><b>Status Ketenagakerjaan </b></label>
                            <input type="hidden" name="id_kerja" id="id_kerja">
                            <?php echo form_dropdown('stt', $stt, $this->input->post('stt', TRUE), 'class="select-all" id="stt"'); ?>
