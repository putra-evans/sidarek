...
class Koperasi extends SLP_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('model_koperasi' => 'mkop'));
        $this->csrf = array(
    ...
    public function index()
    {
        ...
        $this->session_info['page_name'] = "Data Master: Koperasi";
        $this->session_info['regency'] = $this->getRegency();

        $this->template->build('form_koperasi/list', $this->session_info);
    }
    ...
    public function listview()
    {
        ...
        if (!$this->input->is_ajax_request() || empty($session)) {
            ...
            $resultDT = $this->mkop->process_datatables($param);
    ...
    public function create()
    {
        ...
        if (!$this->input->is_ajax_request()) {
            ...
            if ($this->mkop->validasiDataValue('new') == false) {
                $result = array('status' => 0, 'message' => $this->form_validation->error_array());
            } else {
                $result = $this->mkop->insert_data();
            }
