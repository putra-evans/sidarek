<script type="text/javascript">
  $(function() {
    ...
    mainTbl = $('#mainTbl').dataTable({
      ...
      ordering: false,
      ajax: {
        url: site + "ekonomikoperasi/peragaan/listview",
        type: "POST",
        data: function(d) {
    ...
    // Form Reset
    function formReset() {
      $('#formEntry').attr('action', site + 'ekonomikoperasi/peragaan/create');
      $('#errEntry').html('');
      $('.help-block').text('');
    ...
    $(document).on('click', '.btnEdit', function(e) {
      ...
      e.stopPropagation();
      formReset();
      $('#formEntry').attr('action', site + 'ekonomikoperasi/peragaan/update');
    ...
    $(document).on('click', '.btnDelete', function(e) {
      ...
      var postData = {
        'id_peragaan_koperasi': idSubsidi,
        ...
        buttons: {
          ...
          "main": {
            ...
            callback: function(response) {
              if (response) {
                $.ajax({
                  url: site + 'ekonomikoperasi/peragaan/delete',
                  type: "POST",
                  data: postData,
                  dataType: "json",
                }).done(function(data) {
