<script type="text/javascript">
  $(function() {
    ...
    var mainTbl;
    var urlTbl = site + "ekonomikoperasi/peragaankabkota/listview/" + '<?php echo isset($tahun) ? $tahun : ''; ?>'
    ...
    // Form Reset
    function formReset() {
      $('#formEntry').attr('action', site + 'ekonomikoperasi/peragaankabkota/create');
      $('#errEntry').html('');
      $('.help-block').text('');
        ...
        buttons: {
          ...
          "main": {
            ...
            callback: function(response) {
              if (response) {
                $.ajax({
                  url: site + 'ekonomikoperasi/peragaankabkota/delete',
                  type: "POST",
                  data: postData,
                  dataType: "json",
                }).done(function(data) {
