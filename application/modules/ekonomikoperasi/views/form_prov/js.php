<script type="text/javascript">
  $(function() {
    ...
    var mainTbl;
    var urlTbl = site + "ekonomikoperasi/peragaanprov/listview/" + '<?php echo isset($tahun) ? $tahun : ''; ?>'
    ...
    mainTbl = $('#mainTbl').dataTable({
      ...
      columns: [
        ...
        {
          data: "kategori_koperasi",
          className: "text-left",
        },
        {
          data: "total_jumlah_unit",
          className: "text-right"
        },
        {
          data: "total_unit_aktif",
          className: "text-right"
        },
        {
          data: "total_unit_nonaktif",
          className: "text-right"
        },
        // {
        //   data: "total_jumlah_anggota",
        //   className: "text-right"
        // },
        // {
        //   data: "total_anggota_laki",
        //   className: "text-right"
        // },
        // {
        //   data: "total_anggota_perempuan",
        //   className: "text-right"
        // },
        {
          data: "total_unit_rat",
        ...
        {
          data: "total_persen_rat",
          className: "text-right"
        },
        // {
        //   data: "total_jumlah_manager",
        //   className: "text-right"
        // },
        // {
        //   data: "total_manager_laki",
        //   className: "text-right"
        // },
        // {
        //   data: "total_manager_perempuan",
        //   className: "text-right"
        // },
        // {
        //   data: "total_jumlah_karyawan",
        //   className: "text-right"
        // },
        // {
        //   data: "total_karyawan_laki",
        //   className: "text-right"
        // },
        // {
        //   data: "total_karyawan_perempuan",
        //   className: "text-right"
        // },
        {
          data: "total_modal_sendiri",
          className: "text-right"
        },
        {
          data: "total_modal_luar",
          className: "text-right"
        },
        {
          data: "total_aset",
    ...
    // Form Reset
    function formReset() {
      $('#formEntry').attr('action', site + 'ekonomikoperasi/peragaanprov/create');
      $('#errEntry').html('');
      $('.help-block').text('');
      ...
      $('#kategori_koperasi').val('').trigger('change');
      $('#id_peragaan_koperasi').val('');
      $('#total_jumlah_unit').val('');
      $('#total_unit_aktif').val('');
      $('#total_unit_nonaktif').val('');
      $('#total_jumlah_anggota').val('');
      $('#total_anggota_laki').val('');
      $('#total_anggota_perempuan').val('');
      $('#total_unit_rat').val('');
      $('#total_persen_rat').val('');
      $('#total_jumlah_manager').val('');
      $('#total_manager_laki').val('');
      $('#total_manager_perempuan').val('');
      $('#total_jumlah_karyawan').val('');
      $('#total_karyawan_laki').val('');
      $('#total_karyawan_perempuan').val('');
      $('#total_modal_sendiri').val('');
      $('#total_modal_luar').val('');
      $('#total_aset').val('');
      $('#total_volume_usaha').val('');
      $('#total_snu').val('');
    }
    ...
    $(document).on('click', '.btnEdit', function(e) {
      ...
      e.stopPropagation();
      formReset();
      $('#formEntry').attr('action', site + 'ekonomikoperasi/peragaanprov/update');

      $('#id_peragaan_prov').val(data.id_peragaan_prov).trigger('change');
      $('#tahun').val(data.tahun).trigger('change');
      $('#kategori_koperasi').val(data.kategori_koperasi).trigger('change');      
      ...
      $('#total_unit_nonaktif').val(data.total_unit_nonaktif);
      $('#total_jumlah_anggota').val(data.total_jumlah_anggota);
      $('#total_anggota_laki').val(data.total_anggota_laki);
      $('#total_anggota_perempuan').val(data.total_anggota_perempuan);
      $('#total_unit_rat').val(data.total_unit_rat);
      $('#total_persen_rat').val(data.total_persen_rat);
      $('#total_jumlah_manager').val(data.total_jumlah_manager);
      $('#total_manager_laki').val(data.total_manager_laki);
      $('#total_manager_perempuan').val(data.total_manager_perempuan);
      $('#total_jumlah_karyawan').val(data.total_jumlah_karyawan);
      $('#total_karyawan_laki').val(data.total_karyawan_laki);
      $('#total_karyawan_perempuan').val(data.total_karyawan_perempuan);
      $('#total_modal_sendiri').val(data.total_modal_sendiri);
      $('#total_modal_luar').val(data.total_modal_luar);
      $('#total_aset').val(data.total_aset);
      $('#total_volume_usaha').val(data.total_volume_usaha);
      $('#total_snu').val(data.total_snu);
    ...
    $(document).on('click', '.btnDelete', function(e) {
      ...
      var dataItem = $(this).data('id');
      var postData = {
        'id_peragaan_prov': dataItem,
        ...
        buttons: {
          ...
          "main": {
            ...
            callback: function(response) {
              if (response) {
                $.ajax({
                  url: site + 'ekonomikoperasi/peragaanprov/delete',
                  type: "POST",
                  data: postData,
                  dataType: "json",
                }).done(function(data) {
