  ...
  <div class="modal-dialog modal-lg" id="frmEntry">
    <div class="modal-content">
      <div class="modal-header" style="padding:10px 15px 10px 15px;">
        ...
        <h4 class="modal-title"><b><span id="judul-form"> </span>PERAGAAN KOPERASI DI PROVINSI</b></h4>
      </div>
      ...
      <div class="modal-body" style="padding:15px 15px 5px 15px;">
        <div id="errEntry"></div>
        <div class="row">
          <input type="hidden" id="id_peragaan_prov" name="id_peragaan_prov">
          ...
          <div class="col-xs-12 col-sm-12">
            <div class="form-group required">
              ...
              <?php echo form_dropdown('tahun', array('' => '-- Semua Tahun --', 2020 => '2020', 2019 => '2019', 2018 => '2018', 2017 => '2017', 2016 => '2016', 2015 => '2015', 2014 => '2014', 2013 => '2013', 2012 => '2012', 2011 => '2011', 2010 => '2010', 2009 => '2009'), $this->input->post('rujukan'), 'class="select-all" id="tahun"'); ?>
          ...
          <div class="col-xs-12 col-sm-12">
            <div class="form-group required">
              <label for="kategori_koperasi" class="control-label"><b>Kategori <font color="red">*</font></b></label>
              <?php echo form_dropdown('kategori_koperasi', array('' => '-- Pilih Kategori --', 'primer' => 'Primer', 'sekunder' => 'Sekunder'), $this->input->post('kategori_koperasi', TRUE), 'class="select-all" id="kategori_koperasi"'); ?>
              <div class="help-block"></div>
            </div>
          </div>
