<script type="text/javascript">
    $(function() {
        ...
        mainTbl = $('#mainTbl').dataTable({
            ...
            ordering: false,
            ajax: {
                url: site + "ekonomikoperasi/koperasi/listview/",
                type: "POST",
                data: function(d) {
        ...
        // Form Reset
        function formReset() {
            $('#formEntry').attr('action', site + 'ekonomikoperasi/koperasi/create');
            $('#errEntry').html('');
            $('.help-block').text('');
            ...
            $('#alamat').val('');
            $('#tanggal_izin_usaha').val('');
            $('#surat_ojk').val('');

            $('#id_regency').val('').trigger('change');
            $('#status').val('').trigger('change');
            $('#badan_hukum').val('').trigger('change');
            $('#jenis_usaha').val('').trigger('change');
            $('#izin_usaha').val('').trigger('change');
        ...
        $(document).on('click', '.btnEdit', function(e) {
            ...
            e.stopPropagation();
            formReset();
            $('#formEntry').attr('action', site + 'ekonomikoperasi/koperasi/update');

            $('#id_koperasi').val(data.id_koperasi);
            $('#nama').val(data.nama);

            $('#alamat').val(data.alamat);
            $('#tanggal_izin_usaha').val(data.tanggal_izin_usaha);
            $('#surat_ojk').val(data.surat_ojk);

            $('#id_regency').val(data.id_regency).trigger('change');
            $('#status').val(data.status).trigger('change');
            $('#badan_hukum').val(data.badan_hukum).trigger('change');
            $('#jenis_usaha').val(data.jenis_usaha).trigger('change');
            $('#izin_usaha').val(data.izin_usaha).trigger('change');
                ...
                buttons: {
                    ...
                    "main": {
                        ...
                        callback: function(response) {
                            if (response) {
                                $.ajax({
                                    url: site + 'ekonomikoperasi/koperasi/delete',
                                    type: "POST",
                                    data: postData,
                                    dataType: "json",
                                }).done(function(data) {
