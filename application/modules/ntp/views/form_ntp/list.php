                    ...
                    <div class="table-responsive">
                        ...
                        <div class="clearfix">
                            <div class="pull-left form-group clearfix">
                                <button type="button" class="btn btn-primary" id="btnAdd"><b><i class="fa fa-plus"></i> Tambah</b></button>
                            </div>
                        </div>
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-hover table-bordered table-striped" id="ntptbl" width="100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Bulan NTP</th>
...
<?php $this->load->view("ntp/form_ntp/modal.php") ?>
<?php $this->load->view("ntp/form_ntp/js.php") ?>