<script type="text/javascript">
  $(function() {
    ...
    sdatbl = $('#sdatbl').dataTable({
      ...
      ordering: false,
      ajax: {
        url: site + "sda/energitambang/listview",
        type: "POST",
        data: function(d) {
    ...
    $('#id_sektor_filter').on('change', function() {
      ...
      var url = site + '/sda/energitambang/fetch';
      $.ajax({
        url: url,
        type: "POST",
        data: {
    ...
    // Form Reset
    function formReset() {
      $('#formEntry').attr('action', site + 'sda/energitambang/create');
      $('#errEntry').html('');
      $('.help-block').text('');
    ...
    $(document).on('click', '.btnEdit', function(e) {
      ...
      e.stopPropagation();
      formReset();
      $('#formEntry').attr('action', site + 'sda/energitambang/update');
        ...
        buttons: {
          ...
          "main": {
            ...
            callback: function(response) {
              if (response) {
                $.ajax({
                  url: site + 'sda/energitambang/delete',
                  type: "POST",
                  data: postData,
                  dataType: "json",
                }).done(function(data) {
