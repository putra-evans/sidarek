<script type="text/javascript">
  $(function() {
    ...
    sdatbl = $('#sdatbl').dataTable({
      ...
      ordering: false,
      ajax: {
        url: site + "sda/pertanian/listview",
        type: "POST",
        data: function(d) {
    ...
    $('#id_sektor_filter').on('change', function() {
      ...
      var url = site + '/sda/pertanian/fetch';
      $.ajax({
        url: url,
        type: "POST",
        data: {
    ...
    // Form Reset
    function formReset() {
      $('#formEntry').attr('action', site + 'sda/pertanian/create');
      $('#errEntry').html('');
      $('.help-block').text('');
    ...
    $(document).on('click', '.btnEdit', function(e) {
      ...
      e.stopPropagation();
      formReset();
      $('#formEntry').attr('action', site + 'sda/pertanian/update');
