<script type="text/javascript">
  $(function() {
    ...
    sdatbl = $('#sdatbl').dataTable({
      ...
      ordering: false,
      ajax: {
        url: site + "sda/lingkungan/listview",
        type: "POST",
        data: function(d) {
    ...
    $('#id_sektor_filter').on('change', function() {
      ...
      var url = site + '/sda/lingkungan/fetch';
      $.ajax({
        url: url,
        type: "POST",
        data: {
    ...
    // Form Reset
    function formReset() {
      $('#formEntry').attr('action', site + 'sda/lingkungan/create');
      $('#errEntry').html('');
      $('.help-block').text('');
    ...
    $(document).on('click', '.btnEdit', function(e) {
      ...
      e.stopPropagation();
      formReset();
      $('#formEntry').attr('action', site + 'sda/lingkungan/update');
        ...
        buttons: {
          ...
          "main": {
            ...
            callback: function(response) {
              if (response) {
                $.ajax({
                  url: site + 'sda/lingkungan/delete',
                  type: "POST",
                  data: postData,
                  dataType: "json",
                }).done(function(data) {
