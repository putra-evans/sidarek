<script type="text/javascript">
  $(function() {
    ...
    sdatbl = $('#sdatbl').dataTable({
      ...
      ordering: false,
      ajax: {
        url: site + "sda/produksi/listview",
        type: "POST",
        data: function(d) {
    ...
    $('#id_sektor_filter').on('change', function() {
      ...
      var url = site + '/sda/produksi/fetch';
      $.ajax({
        url: url,
        type: "POST",
        data: {
    ...
    // Form Reset
    function formReset() {
      $('#formEntry').attr('action', site + 'sda/produksi/create');
      $('#errEntry').html('');
      $('.help-block').text('');
    ...
    $(document).on('click', '.btnEdit', function(e) {
      ...
      e.stopPropagation();
      formReset();
      $('#formEntry').attr('action', site + 'sda/produksi/update');
    ...
    $(document).on('click', '#printExcel', function(e) {
      let sektor = $('#formFilter').find('select[name="id_sektor_filter"]').val();
