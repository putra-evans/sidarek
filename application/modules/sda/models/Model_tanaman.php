...
class Model_tanaman extends CI_Model
{
	...
	public function insert_data_produksi()
	{
		...
		try {
			...
			$result['success'] = 'YEAH';
			$result['status'] = true;
			$result['message'] = 'Data Tanaman Pangan dan Holtikultura Berhasil Disimpan';
		} catch (\Exception $e) {
	...
	public function update_data_produksi()
	{
		...
		try {
			...
			if ($produk) {
				...
				$result['success'] = 'YEAH';
				$result['status'] = true;
				$result['message'] = 'Data Tanaman Pangan dan Holtikultura Berhasil diupdate';
			}
		} catch (\Exception $e) {
			$result['info'] = $e->getMessage();
		}
