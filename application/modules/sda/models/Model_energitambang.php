...
class Model_energitambang extends CI_Model
{
	...
	public function insert_data_produksi()
	{
		...
		try {
			...
			$result['success'] = 'YEAH';
			$result['status'] = true;
			$result['message'] = 'Data Energi dan Pertambangan Berhasil Disimpan';
		} catch (\Exception $e) {
	...
	public function update_data_produksi()
	{
		...
		try {
			...
			if ($produk) {
				...
				$result['success'] = 'YEAH';
				$result['status'] = true;
				$result['message'] = 'Data Energi dan Pertambangan Berhasil diupdate';
			}
		} catch (\Exception $e) {
			$result['info'] = $e->getMessage();
		}
