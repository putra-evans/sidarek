        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="form-group required">
              ...
              <?php echo form_dropdown('id_tipe', array('' => 'Pilih Data', 1 => 'Pusat', 2 => 'Daerah'), $this->input->post('id_tipe'), 'class="select-all" id="id_tipe_kebijakan"'); ?>
              <div class="help-block"></div>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-6">
            <div class="form-group required">
              <label for="tahun" class="control-label"><b>Tahun Kebijakan <font color="red">*</font></b></label>
              <div class="input-group date monday_date_datepicker" data-provide="datepicker" id="monday_date_datepicker">
                <input type="text" id="tahun_kebijakan" name="tahun" class="form-control" data-date-format="yyyy" readonly>
          ...
          <div class="col-xs-12 col-sm-12">
            <div class="form-group required">
              ...
              <span>
                <font color="red">*</font> <b>File upload harus kurang dari 1 MB</b>
              </span>
            </div>
          </div>
