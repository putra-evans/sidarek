<script type="text/javascript">
    $(function() {
        ...
        mainTbl = $('#mainTbl').dataTable({
            ...
            ordering: false,
            ajax: {
                url: site + "ekonomi_makro_mikro_pariwisata/wisman/listview/",
                type: "POST",
                data: function(d) {
        ...
        // Form Reset
        function formReset() {
            $('#formEntry').attr('action', site + 'ekonomi_makro_mikro_pariwisata/wisman/create');
            $('#errEntry').html('');
            $('.help-block').text('');
        ...
        $(document).on('click', '.btnEdit', function(e) {
            ...
            e.stopPropagation();
            formReset();
            $('#formEntry').attr('action', site + 'ekonomi_makro_mikro_pariwisata/wisman/update');

            $('#id_wisman').val(data.id_wisman);
            $('#id_bangsa').select2('val', data.id_bangsa);
                ...
                buttons: {
                    ...
                    "main": {
                        ...
                        callback: function(response) {
                            if (response) {
                                $.ajax({
                                    url: site + 'ekonomi_makro_mikro_pariwisata/wisman/delete',
                                    type: "POST",
                                    data: postData,
                                    dataType: "json",
                                }).done(function(data) {
        ...
        $(document).on('click', '#printExcel', function(e) {
            let bangsa = $('#formFilter').find('select[name="bangsa"]').val();
            let tahun = $('#formFilter').find('select[name="monday_date"]').val();

            // //(sektor)
            // let id_tipe = $('#formFilter').find('select[name="id_tipe"]').val();
            url = site + 'ekonomi_makro_mikro_pariwisata/wisman/export-to-excel?bangsa=' + bangsa + '&tahun=' + tahun;
