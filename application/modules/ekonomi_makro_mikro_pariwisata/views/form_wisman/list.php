                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group">
                                    <label style="font-size:16px;"><b>Berdasarkan Bangsa </b></label>
                                    <?php echo form_dropdown('bangsa', $bangsa, $this->input->post('bangsa', TRUE), 'class="select-all"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3">
...
<?php $this->load->view("ekonomi_makro_mikro_pariwisata/form_wisman/modal.php") ?>
<?php $this->load->view("ekonomi_makro_mikro_pariwisata/form_wisman/js.php") ?>