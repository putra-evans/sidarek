    ...
    <div class="modal-dialog modal-default" id="frmEntry">
        <div class="modal-content">
            <div class="modal-header" style="padding:10px 15px 10px 15px;">
                ...
                <h4 class="modal-title"><b><span id="judul-form"> </span>KEBANGSAAN PARIWISATA</b></h4>
            </div>
            <?php echo form_open_multipart(site_url('ekonomi_makro_mikro_pariwisata/bangsa/create'), array('id' => 'formEntry')); ?>
            <div class="modal-body" style="padding:15px 15px 5px 15px;">
                <div id="errEntry"></div>
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group required">
                            <input type="hidden" name="id_bangsa" id="id_bangsa">
                            <label for="nama" class="control-label"><b>Nama Kebangsaan <font color="red">*</font></b></label>
                            <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Kebangsaan Impor">
