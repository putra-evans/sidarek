                ...
                <div class="col-xs-12 col-sm-12">
                    ...
                    <div style="display:block;background:#FFF;padding:20px;border:1px solid #CCC;box-shadow:0px 0px 10px #CCC;">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group">
                                    <label style="font-size:16px;"><b>Berdasarkan Bank </b></label>
                                    <?php echo form_dropdown('id_perbankan_filter', $bank, $this->input->post('id_perbankan_filter', TRUE), 'class="select-all"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group">
...
<?php $this->load->view("ekonomikredit/form_bank/modal.php") ?>
<?php $this->load->view("ekonomikredit/form_bank/js.php") ?>