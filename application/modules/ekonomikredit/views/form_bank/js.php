<script type="text/javascript">
    $(function() {
        ...
        mainTbl = $('#mainTbl').dataTable({
            ...
            ordering: false,
            ajax: {
                url: site + "ekonomikredit/kreditbank/listview/",
                type: "POST",
                data: function(d) {
        ...
        // Form Reset
        function formReset() {
            $('#formEntry').attr('action', site + 'ekonomikredit/kreditbank/create');
            $('#errEntry').html('');
            $('.help-block').text('');
            ...
            $('#id_kredit_perbankan').val('').trigger('change');
        ...
        $(document).on('click', '.btnEdit', function(e) {
            ...
            e.stopPropagation();
            formReset();
            $('#formEntry').attr('action', site + 'ekonomikredit/kreditbank/update');

            $('#id_kredit_perbankan').val(data.id_kredit_perbankan);
            $('#id_perbankan').val(data.id_perbankan).trigger('change');
                ...
                buttons: {
                    ...
                    "main": {
                        ...
                        callback: function(response) {
                            if (response) {
                                $.ajax({
                                    url: site + 'ekonomikredit/kreditbank/delete',
                                    type: "POST",
                                    data: postData,
                                    dataType: "json",
                                }).done(function(data) {
        ...
        $(document).on('click', '#printExcel', function(e) {
            ...
            let id_perbankan_filter = $('#formFilter').find('select[name="id_perbankan_filter"]').val();

            url = site + 'ekonomikredit/kreditbank/export-to-excel?tahun=' + tahun_filter + '&bank=' + id_perbankan_filter;
