    ...
    <div class="modal-dialog modal-default" id="frmEntry">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:15px 15px 5px 15px;">
                <div id="errEntry"></div>
                <div class="row">
                    <input type="hidden" name="id_kredit_perbankan" id="id_kredit_perbankan">

                    <div class="col-xs-12 col-sm-12">
                        <div class="form-group required">
                            <label for="id_perbankan" class="control-label"><b>Bank<font color="red">*</font></b></label>
                            <?php echo form_dropdown('id_perbankan', $bank, $this->input->post('id_perbankan', TRUE), 'class="select-all" id="id_perbankan"'); ?>
