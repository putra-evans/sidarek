                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <?php echo form_dropdown('id_sektor_ekonomi_filter', $sektor_ekonomi, $this->input->post('id_sektor_ekonomi_filter', TRUE), 'class="select-all"'); ?>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3">
                                <div class="form-group">
...
<?php $this->load->view("ekonomikredit/form_sektor/modal.php") ?>
<?php $this->load->view("ekonomikredit/form_sektor/js.php") ?>