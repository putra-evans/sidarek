<script type="text/javascript">
    $(function() {
        ...
        mainTbl = $('#mainTbl').dataTable({
            ...
            ordering: false,
            ajax: {
                url: site + "ekonomikredit/kreditsektor/listview/",
                type: "POST",
                data: function(d) {
        ...
        // Form Reset
        function formReset() {
            $('#formEntry').attr('action', site + 'ekonomikredit/kreditsektor/create');
            $('#errEntry').html('');
            $('.help-block').text('');
            ...
            $('#id_sektor_ekonomi').val('').trigger('change');
        ...
        $(document).on('click', '.btnEdit', function(e) {
            ...
            e.stopPropagation();
            formReset();
            $('#formEntry').attr('action', site + 'ekonomikredit/kreditsektor/update');

            $('#id_kredit_persektor').val(data.id_kredit_persektor);
            $('#id_sektor_ekonomi').val(data.id_sektor_ekonomi).trigger('change');
            $('#tahun').val(data.tahun).trigger('change');

            $('#akad').val(data.akad);
            $('#outstanding').val(data.outstanding);
            $('#debitur').val(data.debitur);
            $('#rerata').val(data.rerata);
                ...
                buttons: {
                    ...
                    "main": {
                        ...
                        callback: function(response) {
                            if (response) {
                                $.ajax({
                                    url: site + 'ekonomikredit/kreditsektor/delete',
                                    type: "POST",
                                    data: postData,
                                    dataType: "json",
                                }).done(function(data) {
        ...
        $(document).on('click', '#printExcel', function(e) {
            ...
            let id_sektor_ekonomi_filter = $('#formFilter').find('select[name="id_sektor_ekonomi_filter"]').val();

            url = site + 'ekonomikredit/kreditsektor/export-to-excel?tahun=' + tahun_filter + '&sektor=' + id_sektor_ekonomi_filter;
