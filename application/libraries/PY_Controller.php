...
class PY_Controller extends MY_Controller {
  ...
  public function __construct() {
    ...
    $this->session_info['app_footer'] = "Hak Cipta ©" . ((date('Y') == "2020") ? "2020" : "2020 - ".date('Y')) . " " . "Si-Darek. <i>Powerd by</i> Team IT Kominfo Prov. Sumbar";
